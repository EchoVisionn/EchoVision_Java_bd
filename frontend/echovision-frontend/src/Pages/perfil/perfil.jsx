...
// Imagens da tela de perfil
import autoCompadecida from '../../assets/imagens/auto-da-compadecida.jpeg';
import tarsila from '../../assets/imagens/tarsila-do-amaral.jpg';
              ...
              <form className="profile-form" onSubmit={e => e.preventDefault()}>
                <div className="form-row">
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" id="sobrenome" defaultValue="" />
                  </div>
                </div>
                ...
                <div className="form-row triplet">
                  <div className="form-group">
                    ...
                    <input type="text" id="pais" defaultValue="" />
                  </div>
                  <div className="form-group">
                    <label htmlFor="doc">Tipo de documento</label>
                    <input type="text" id="doc" defaultValue="" />
                  </div>
                  <div className="form-group">
                    <label htmlFor="cpf">CPF</label>
                    <input type="text" id="cpf" defaultValue="" />
                  </div>
                </div>
